...
function LoginSignup() {
  ...
  // Listen for signup mode event
  useEffect(() => {
    const handleSetSignupMode = () => {
      setIsLogin(false)
    }
    window.addEventListener('setSignupMode', handleSetSignupMode)
    return () => {
      window.removeEventListener('setSignupMode', handleSetSignupMode)
    }
  }, [])
  ...
  return (
    <>
      ...
      <div style={{
        ...
        border: `2px solid ${isLogin ? '#EB8E89' : '#06384D'}`,
        borderRadius: 0,
        padding: '40px',
        width: '100%',
        maxWidth: '400px',
          ...
          <div>
            ...
            <input
              ...
              style={{
                width: '100%',
                padding: '12px',
                border: `1px solid ${isLogin ? '#EB8E89' : '#06384D'}`,
                borderRadius: '6px',
                fontSize: '16px',
              ...
              className={isLogin ? "login-input" : "signup-input"}
            />
          </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0px', textAlign: 'center', fontSize: '14px', fontFamily: "'Manrope', sans-serif", color: "var(--color-text-secondary)" }}>
          {isLogin ? (
            <>
              <p style={{ margin: 0, color: '#12707C' }}>
                Want to register your orphanage?{' '}
                <button
                  type="button"
                  onClick={() => {
